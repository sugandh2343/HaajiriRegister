...
public class AdapterLabourSelect extends RecyclerView.Adapter<AdapterLabourSelect.HolderLabourSelect> {

    private Context context;
    private ArrayList<ModelLabour> labourArrayList;

    public AdapterLabourSelect(Context context, ArrayList<ModelLabour> labourArrayList) {
    ...
    @NonNull
    @Override
    public AdapterLabourSelect.HolderLabourSelect onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.layout_select_labour_single_row,parent,false);
        return new AdapterLabourSelect.HolderLabourSelect(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterLabourSelect.HolderLabourSelect holder, int position) {
        ...
        holder.txt_site_id.setText(String.valueOf(modelLabour.getSiteCode()));
...
//                    intent.putExtra("workerDeletedType", workerType);
    ...
    public class HolderLabourSelect extends RecyclerView.ViewHolder {
        CheckBox cb_select;
        ImageView img_profile;
        TextView txt_name,txt_labour_id,txt_wages,txt_type,txt_site_id;
        public HolderLabourSelect(@NonNull View itemView) {
            super(itemView);
