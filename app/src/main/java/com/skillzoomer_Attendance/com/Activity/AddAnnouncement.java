...
import com.skillzoomer_Attendance.com.databinding.ActivityAddAnnouncementBinding;
...
public class AddAnnouncement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.child("Announcements").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                eventCategories.add(0,new ModelEventCategory(0,"Select Announcement Category"));
                AddAnnouncement.eventCategoryAdapter eventCategoryAdapter=new AddAnnouncement.eventCategoryAdapter();
        ...
        binding.etEventDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddAnnouncement.this, date1, myCalendar
...
//            }
        ...
        binding.btnAddEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(TextUtils.isEmpty(binding.etEventName.getText().toString())){
                    Toast.makeText(AddAnnouncement.this, "Enter the event's name", Toast.LENGTH_SHORT).show();
                }else if(TextUtils.isEmpty(binding.etEventDate.getText().toString())){
                    Toast.makeText(AddAnnouncement.this, "Select Event Date", Toast.LENGTH_SHORT).show();
                }else if(binding.spinnerEventCategory.getSelectedItemPosition()==0){
                    Toast.makeText(AddAnnouncement.this, "Select Event Category", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    private void addEvent(DatabaseReference reference, long eventId) {
        tempEventId=eventId;
        reference.child("Events").child("Announcement").child(String.valueOf(eventId)).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    reference.child("Events").child("Announcement").child(String.valueOf(eventId)).setValue(hashMap)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void unused) {
                                    Toast.makeText(AddAnnouncement.this, "Event Added Successfully", Toast.LENGTH_SHORT).show();
                                    Intent intent1=new Intent(AddAnnouncement.this,EventnAnnouncementHome.class);
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AddAnnouncement.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
